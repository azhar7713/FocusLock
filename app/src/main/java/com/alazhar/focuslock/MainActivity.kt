...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val clearBlocksButton = findViewById<Button>(R.id.buttonClearBlocks)
        ...
        clearBlocksButton.setOnClickListener {
            WordsRepository.clearAllBlocks(this)
            Toast.makeText(this, "تم إلغاء جميع الحظورات الحالية", Toast.LENGTH_SHORT).show()
        }
    }
}
